    ...
    common: {
      ...
      landing: {
        ...
        newHero: {
          ...
          headlinePre: '불확실한 데이터에서',
          headlineAccent: '명확한 실행을',
          headlinePost: '추출합니다',
          rotatingWord1: '리스크 구조화까지.',
          rotatingWord2: '의사결정 최적화까지.',
          rotatingWord3: '운영 자동화까지.',
          sub: '시계열 예측 AI로 상태를 예측하고, 리스크최소화 중심 레이어를 결합해, 금융 환경에서 실행 가능한 판단을 만드는 AI 인프라입니다.',
          ctaPrimary: '문의하기',
          ctaSecondary: '기술 소개서 보기',
          stat1Value: '82.5%',
          stat1Label: '하락 구간 식별 정확도',
          stat2Value: 'PoC',
          stat2Label: 'IBK 기업은행 협업',
          stat3Value: '리스크 통제',
          stat3Label: '리스크 기반 의사결정',
          step1Title: 'Predict',
          step1Desc: '시계열 예측 AI 기반 상태 예측',
          step2Title: 'Structure',
          step2Desc: '리스크최소화 중심 리스크 구조화',
          step3Title: 'Decide',
          step3Desc: '리스크를 반영한 최적 의사결정 도출',
          visualLabel: 'Decision Architecture',
          nodeData: 'Data',
          nodeDataSub: '시계열 수집',
          nodePredict: 'Predict',
          nodePredictSub: '상태 예측',
          nodeStructure: 'Structure',
          nodeStructureSub: '리스크 구조화',
          nodeDecide: 'Decide',
          nodeDecideSub: '최적 실행',
        },
        nav: {
        ...
        about: {
          ...
          step1Title: '상태 표현 계층',
          step1Desc:
            '원시 데이터를 맥락을 담은 상태 표현으로 변환합니다. 변수가 바뀌어도 운영 문구만 조정하면 됩니다.',
          step2Title: '상태 전이 예측',
          step2Desc:
            '시계열 예측 AI 기반으로 다음 값이 아닌 상태의 가능성을 예측합니다.',
        ...
        service: {
          ...
          b2cLabel: 'GLAB — B2C',
          b2cColumnDesc:
            '리테일 투자자를 위한 GLAB·포트폴리오 엔진과 교육·커뮤니티를 제공합니다.',
          investAreaLabel: '투자영역',
          nonInvestAreaLabel: '비투자영역',
          ...
          card2Title: '포트폴리오 엔진',
          card2Desc:
            '시계열 예측 AI 기반 종목 예측과 리스크최소화 중심 포트폴리오 구성을 결합합니다. 극단적 손실 가능성을 줄이는 구성을 자동으로 만들고 리밸런싱합니다.',
          card2Tag1: '시계열 예측 AI',
          card2Tag2: '극단 손실 완화',
          card2Tag3: '자동 리밸런싱',
        ...
        projects: {
          ...
          card1Title: '시계열 예측 AI 기반 포트폴리오 운용',
          card1Desc:
            'DART 재무제표를 활용하여 기업 펀더멘탈을 예측하고, 리스크최소화 중심 알고리즘으로 리스크를 줄이는 포트폴리오를 운용합니다.',
          card1Meta1: '운용심사 통과',
          card1Meta2: '특허 등록',
          card2Title: '카드 고객 이탈방지 모형',
          card2Desc:
            'IBK 1st LAB에서 시계열 예측 AI를 카드 고객 이탈 예측에 적용했습니다. 이탈 원인별 차별화된 리텐션 전략을 자동으로 도출합니다.',
          card2Meta2: 'PoC 진행중',
          ...
          b2b1Title: '증권 / 자산운용',
          b2b1Desc:
            '사모펀드 B2B 자문 운용 중. 시계열 예측 AI와 리스크최소화 중심 포트폴리오로 PB 의사결정을 지원합니다.',
          b2b2Status: 'PoC 진행중',
        ...
        achievements: {
          ...
          timelineTitle: '연혁',
          evidenceTitle: '보도 · 증빙',
          partnersTitle: '협력 · 연계 기관',
          partners: {
            snu: '서울대학교',
            snuVmth: '서울대학교 수의과대학 동물병원',
            uos: '서울시립대학교',
            lgCns: 'LG CNS',
            seoulFintech: '서울핀테크랩',
            ibk: 'IBK 기업은행',
          ...
          timeline: {
            i1: '관악연구소 설립',
            i2: '핀테크 AI 개발 (서울시립대학교와 공동연구개발)',
            i3: '로보어드바이저 테스트베드 운용심사 통과',
            i4: 'LG CNS 생성형 AI 기반 이미지 편집툴, COP 프로젝트 개발',
            i5: '핀테크 AI, 특허 등록 완료',
            i6: '서울핀테크랩 멤버십 기업 선정',
            i7: '동물병원 통합 데이터베이스 구축 프로젝트 개발',
            i8: 'IBK 1st LAB 7기 선정 (카드고객이탈방지 모델 구축 PoC)',
            i9: '기보벤처캠프 18기 선정',
        ...
        renewal: {
          ...
          products: {
            ...
            glabOpenService: 'GLAB 서비스 바로가기',
            glabPreviewLabel: '실제 서비스 화면',
            glabPreviewAlt: 'GLAB 웹 서비스 화면',
            glabCarousel: {
              regionLabel: 'GLAB 앱 실제 화면 (한 번에 2장, 한 칸씩 이동)',
              prev: '이전',
              next: '다음',
              dotsLabel: '화면 위치',
              goTo: '{{n}}번째',
              altScreen: 'GLAB 서비스 화면 {{n}}',
              openLightbox: '크게 보기 (화면 {{n}})',
              closeLightbox: '닫기',
            },
          },
          achievementsHeader: {
  ...
  en: {
    common: {
      ...
      landing: {
        ...
        newHero: {
          tag: 'State-based AI Decision Engine',
          headlinePre: 'From uncertain data,',
          headlineAccent: 'extract clear action',
          headlinePost: '',
          ...
          stat2Value: 'PoC',
          stat2Label: 'IBK Bank Partnership',
          stat3Value: 'Risk control',
          stat3Label: 'Risk-based Decisions',
          step1Title: 'Predict',
          step1Desc: 'Time-series prediction AI for state forecasting',
          step2Title: 'Structure',
          step2Desc: 'Risk-minimization-focused risk structuring',
          step3Title: 'Decide',
          step3Desc: 'Optimal decisions with risk-aware criteria',
          visualLabel: 'Decision Architecture',
          nodeData: 'Data',
          nodeDataSub: 'Time-series',
          nodePredict: 'Predict',
          nodePredictSub: 'State forecast',
          nodeStructure: 'Structure',
          nodeStructureSub: 'Risk mapping',
          nodeDecide: 'Decide',
          nodeDecideSub: 'Optimal action',
        },
        nav: {
          start: 'Get Started',
          portfolio: 'Portfolio',
        ...
        about: {
          ...
          step2Desc:
            'Uses time-series prediction AI to estimate the likelihood of next states, not just next values.',
        ...
        service: {
          ...
          investAreaLabel: 'Investment',
          nonInvestAreaLabel: 'Non-investment',
          card1Title: 'GLAB — 1:1 AI Digital PB',
          card1Desc:
            'Analyzes user propensity and sentiment in real time to suggest personalized investment guidance. While general conversational AI often lists information and stops at uncertainty, GLAB defines market states and provides concrete actions.',
          ...
          card2Desc:
            'Combines time-series prediction AI for return forecasting with risk-minimization-focused portfolio construction. Automatically builds and rebalances portfolios to reduce tail-loss exposure.',
          card2Tag1: 'Time-series prediction AI',
          card2Tag2: 'Tail-loss mitigation',
        ...
        projects: {
          ...
          card1Title: 'Time-series AI–based portfolio management',
          card1Desc:
            'Uses DART financial statements to predict fundamentals and operates portfolios with risk-minimization-focused algorithms.',
          card1Meta1: 'Operation review passed',
          card1Meta2: 'Patent granted',
          card2Title: 'Card customer churn prevention model',
          card2Desc:
            'Applied time-series prediction AI to churn prediction in IBK 1st LAB and automatically derived differentiated retention strategies by churn drivers.',
          ...
          card3Meta2: 'Finance-specialized AI',
          glovLabel: 'GLOV — B2B',
          glovDesc:
          ...
          b2b1Desc:
            'Operating B2B advisory for private funds. Supports PB decision-making with time-series prediction AI and risk-minimization-focused portfolios.',
        ...
        achievements: {
          ...
          partners: {
            ...
            snuVmth: 'SNU Veterinary Medical Teaching Hospital',
            uos: 'University of Seoul',
            lgCns: 'LG CNS',
            seoulFintech: 'Seoul Fintech Lab',
            ibk: 'IBK',
          ...
          timeline: {
            ...
            i2: 'Developed Fintech AI (joint R&D with University of Seoul)',
            i3: 'Passed Robo-advisor testbed operation review',
            i4: 'Developed LG CNS generative AI image editor and COP project',
            i5: 'Fintech AI patent registration completed',
            i6: 'Selected as a Seoul Fintech Lab membership company',
            i7: 'Developed integrated database project for animal hospitals',
            i8: 'Selected for IBK 1st LAB 7th cohort (card churn prevention PoC)',
          ...
          g1i3Title: 'Achieved 82.5% downside segment identification',
        ...
        renewal: {
          ...
          products: {
            ...
            glabOpenService: 'Open GLAB service',
            glabPreviewLabel: 'Live product',
            glabPreviewAlt: 'Screenshot of the GLAB web app',
            glabCarousel: {
              regionLabel: 'GLAB app (2 screens, slide one step)',
              prev: 'Previous',
              next: 'Next',
              dotsLabel: 'Slide position',
              goTo: 'Go to {{n}}',
              altScreen: 'GLAB service screen {{n}}',
              openLightbox: 'Enlarge (screen {{n}})',
              closeLightbox: 'Close',
            },
          },
          achievementsHeader: {
